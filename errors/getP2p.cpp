...
TGraph* getP2p(string tgt="h",string angle="25", string mom="3p5",string spec="shms", string what="boil",double marker=33, double col=1, string name="gr1"){
 ...
 TFile *fd=new TFile(Form("../dataYieldOut/pass50/%s_dataYield_%s.root",spec.c_str(),kind.c_str()));
 ...
 TFile *fh=new TFile(Form("../dataYieldOut/pass50/%s_dataYield_%s.root",spec.c_str(),kinh.c_str()));
