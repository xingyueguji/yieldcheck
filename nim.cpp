#include "plot_nim.cpp"
//#include "plot_cx_raffaella.cpp"

void nim(double angle=21){
  ...
  gROOT->ProcessLine("plot_cx(\"r\",\"21\",\"hms\",\"pass308\",.2,.95,0.48,1.1,.85,1.15,\"xb\",1)");
  ...
  gROOT->ProcessLine("plot_cx(\"r\",\"21\",\"shms\",\"pass308\",.2,.95,0.48,1.1,.85,1.15,\"xb\",1)");
  //  TLegend* l0= (TLegend*)gPad->GetListOfPrimitives()->FindObject("leg_shms");
  //  l0->Delete();


  c1->SaveAs("nim_figure1.pdf");
  //  return;
}
