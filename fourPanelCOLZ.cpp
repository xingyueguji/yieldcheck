...
//.x drawAcc.cpp;
  ...
  heff->GetZaxis()->CenterTitle(1);
  heff->GetZaxis()->SetTitle("Effective Solid Angle (msr)");
  heff->GetXaxis()->SetTitleSize(.06);
  heff->GetYaxis()->SetTitleSize(.06);
  heff->GetZaxis()->SetTitleSize(.06);
  heff->GetXaxis()->SetTitleOffset(0.90);
  heff->GetYaxis()->SetTitleOffset(0.88);
  //  heff->GetZaxis()->SetTitleOffset(1.04);
  gPad->SetRightMargin(.1);
  gPad->SetTopMargin(.1);
  gPad->SetLeftMargin(.1);
