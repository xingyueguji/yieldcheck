...
// * 
void mcWt2(string tgt="h",string angle="21", string mom="3p3", string spec="shms"){
  ...
  ofstream oFile;
  ofstream outFile;
  outFile.open(Form("pass67_mcWt_%s.txt",spec.c_str()),ios::app | ios::out );
...
//match data cuts
  ...
  if(tgt=="alu"||tgt=="ald")
    {
      gr=getRadCorrW2(tgt.c_str(),1,spec.c_str(),"v0.995");  //born
      gr->SetName("gr");
      gr2=getRadCorrW2(tgt.c_str(),2,spec.c_str(),"v0.995");  //born/rad
      gr2->SetName("gr2");
      gr3=getRadCorrW2(tgt.c_str(),3,spec.c_str(),"v0.995");  //rad
      gr3->SetName("gr3");
      tgtDenLen=.18155;
      tgtMass=26.98;
    }
  ...
  if(tgt=="c")
    {
      gr=getRadCorrW2("c",1,spec.c_str(),"v0.995");  //born
      gr->SetName("gr");
      gr2=getRadCorrW2("c",2,spec.c_str(),"v0.995");  //born/rad
      gr2->SetName("gr2");
      gr3=getRadCorrW2("c",3,spec.c_str(),"v0.995");  //rad
      gr3->SetName("gr3");
  ...
  if(tgt=="d")
    {
      gr=getRadCorrW2("d",1,spec.c_str(),"v0.995");  
      gr->SetName("gr");
      gr2=getRadCorrW2("d",2,spec.c_str(),"v0.995");  
      gr2->SetName("gr2");
      gr3=getRadCorrW2("d",3,spec.c_str(),"v0.995");  
      gr3->SetName("gr3");
  ...
  if(tgt=="h")
    {
      gr=getRadCorrW2("h",1,spec.c_str(),"v0.995");  
      gr->SetName("gr");
      gr2=getRadCorrW2("h",2,spec.c_str(),"v0.995");  
      gr2->SetName("gr2");
      gr3=getRadCorrW2("h",3,spec.c_str(),"v0.995");  
      gr3->SetName("gr3");
  ...
  TString fOut=Form("mcWtOut/pass67/%s_mcWt%s.root",spec.c_str(),kin.c_str());
