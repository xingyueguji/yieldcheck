...
void cxAndratios(double angle=20){
  ...
  if(angle==21)
    {
      c1->cd(1);
      gROOT->ProcessLine("plot_cx(\"h\",\"21\",\"shms\",\"pass306\",.2,1.,-.1,4.,.9,1.1,\"xb\")");
      c1->cd(2);
  ...
  if(angle==20)
    {
      c1->cd(1);
      gROOT->ProcessLine("plot_cx(\"h\",\"21\",\"hms\",\"pass306\",.2,1.,-.1,3.,.9,1.1,\"xb\")");
      c1->cd(2);
	gROOT->ProcessLine("plot_cx(\"d\",\"21\",\"hms\",\"pass306\",.2,1.,-.1,6.,.9,1.1,\"xb\")");
      c1->cd(3);
      gROOT->ProcessLine("plot_cx(\"r\",\"21\",\"hms\",\"pass306\",.2,1.,0.5,1.1,.9,1.1,\"xb\")");
    }

  if(angle==25)
    {
      c1->cd(1);
      gROOT->ProcessLine("plot_cx(\"h\",\"25\",\"shms\",\"pass306\",.2,1.,-.1,2.,.85,1.15,\"xb\")");
      c1->cd(2);
  ...
  if(angle==29)
    {
      c1->cd(1);
      gROOT->ProcessLine("plot_cx(\"h\",\"29\",\"shms\",\"pass306\",.2,1.,-.1,1.2,.85,1.15,\"xb\")");
      c1->cd(2);
  ...
  if(angle==33)
    {
      c1->cd(1);
      gROOT->ProcessLine("plot_cx(\"h\",\"33\",\"shms\",\"pass306\",.2,1.,-.1,.8,.85,1.15,\"xb\")");
      c1->cd(2);
  ...
  if(angle==39)
    {
      c1->cd(1);
      gROOT->ProcessLine("plot_cx(\"h\",\"39\",\"shms\",\"pass306\",.2,1.,-.1,.5,.85,1.15,\"xb\")");
      c1->cd(2);
  ...
  c1->SaveAs(Form("shms%2.0fdeg_306.pdf",angle));
  return;
}
