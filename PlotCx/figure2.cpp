...
void figure2(double angle=21){
  ...
  gROOT->ProcessLine("plot_cx(\"r\",\"25\",\"shms\",\"pass313\",.25,.95,0.551,1.12,.85,1.15,\"xb\",1)");
  ...
  gROOT->ProcessLine("plot_cx(\"r\",\"29\",\"shms\",\"pass313\",.25,.95,0.551,1.12,.85,1.15,\"xb\",1)");
  ...
  gROOT->ProcessLine("plot_cx(\"r\",\"33\",\"shms\",\"pass313\",.25,.95,0.551,1.12,.85,1.15,\"xb\",1)");
  ...
  gPad->SetRightMargin(.15);
  gPad->SetLeftMargin(small);
  gROOT->ProcessLine("plot_cx(\"r\",\"39\",\"shms\",\"pass313\",.25,.95,0.551,1.12,.85,1.15,\"xb\",1)");
