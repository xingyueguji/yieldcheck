...
void figure4(double angle=21){
  ...
  gROOT->ProcessLine("plot_cx(\"r\",\"21\",\"hms\",\"pass153\",.2,.95,0.67,1.2,.85,1.15,\"xb\",1)");
  ...
  gROOT->ProcessLine("plot_cx(\"r\",\"21\",\"shms\",\"pass153\",.2,.95,0.48,1.18,.85,1.15,\"xb\",1)");
  TLegend* l0= (TLegend*)gPad->GetListOfPrimitives()->FindObject("leg_shms");
  l0->Delete();


  c1->SaveAs("figure4_153.pdf");
  //  return;
}
