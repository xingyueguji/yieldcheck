...
void  plotTable(){
  ...
  */
  ...
  g1->GetYaxis()->SetTitleSize(.055);
  g2->GetYaxis()->SetTitleSize(.055);
  g3->GetYaxis()->SetTitleSize(.03);
  g1->GetXaxis()->SetTitleSize(.055);
  g2->GetXaxis()->SetTitleSize(.055);
  g3->GetXaxis()->SetTitleSize(.03);  
 ...
 g3->GetYaxis()->CenterTitle();
  ...
  g1->GetYaxis()->SetTitleOffset(.6);
  g2->GetYaxis()->SetTitleOffset(.6);
  g3->GetYaxis()->SetTitleOffset(1.4);
  g1->GetXaxis()->SetTitleOffset(1.);
  g2->GetXaxis()->SetTitleOffset(1.);
			      
  g3->GetXaxis()->SetTitleOffset(1.4);   

  g1->GetXaxis()->SetLabelSize(.06);
  g2->GetXaxis()->SetLabelSize(.06);
  g3->GetXaxis()->SetLabelSize(.05);
  g1->GetYaxis()->SetLabelSize(.06);
  g2->GetYaxis()->SetLabelSize(.06);
