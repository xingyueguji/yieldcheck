...
void compare(){
  ...
  FILE *fp = fopen("f2_data_310.txt","r");  
  FILE *fp2 = fopen("f2_data_311.txt","r");  
...
c6 122
    */
  int start=0;
  TGraph *g=new TGraph(c2,&xb_v[0],&xsec3_v[0]);
  g->SetTitle("Change inD/H ratio");
  g->GetYaxis()->SetTitle("(v995-v990)/v995 * 100");
