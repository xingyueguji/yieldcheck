...
void carbonOptics(string tgt="c",string angle="21", string mom="4p0",string spec="hms",   bool rebin=false){
...
c_s_ypVy->SetPoint(8,31.1869,0.0478448);
 ...
 double m5= fixRange(hm_yptarVytar);
 fixRange(hd_xVy,m1);
 fixRange(hd_xpVyp,m2);
 fixRange(hd_xVxp,m3);
 fixRange(hd_ypVy,m4);
 fixRange(hd_yptarVytar,m5);
