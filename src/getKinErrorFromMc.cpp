...
TH1F* unc(string tgt="h",string angle="21", string mom="5p1",string spec="shms", string pass="pass38", int cs=0){
  //  gStyle->SetOptStat(0);
  ...
  if(cs>=5)hModh=(TH1F*)fModh->Get("w2Wt");
  hModh->SetName("hModh");
  ...
  if(cs>=5)hModd=(TH1F*)fModd->Get("w2Wt");
  hModd->SetName("hModd");
...
TH1F* getKinErrorFromMc(string tgt="h", string angle="21", string mom="5p7",string spec="hms", int cs=0){

  TH1F* h38=unc("h",angle,mom,spec,"pass38",cs);
  TH1F* d38=unc("d",angle,mom,spec,"pass38",cs);
  TH1F* r38=unc("r",angle,mom,spec,"pass38",cs);

  TH1F* h39=unc("h",angle,mom,spec,"pass39",cs);
  TH1F* d39=unc("d",angle,mom,spec,"pass39",cs);
  TH1F* r39=unc("r",angle,mom,spec,"pass39",cs);

  TH1F* h40=unc("h",angle,mom,spec,"pass40",cs);
  TH1F* d40=unc("d",angle,mom,spec,"pass40",cs);
  TH1F* r40=unc("r",angle,mom,spec,"pass40",cs);

  TH1F* h41=unc("h",angle,mom,spec,"pass41",cs);
  TH1F* d41=unc("d",angle,mom,spec,"pass41",cs);
  TH1F* r41=unc("r",angle,mom,spec,"pass41",cs);

  TH1F* h42=unc("h",angle,mom,spec,"pass42",cs);
  TH1F* d42=unc("d",angle,mom,spec,"pass42",cs);
  TH1F* r42=unc("r",angle,mom,spec,"pass42",cs);

  TH1F* h43=unc("h",angle,mom,spec,"pass43",cs);
  TH1F* d43=unc("d",angle,mom,spec,"pass43",cs);
  TH1F* r43=unc("r",angle,mom,spec,"pass43",cs);
