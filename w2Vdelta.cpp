...
void w2Vdelta(string ang="21"){
  ...
  auto g1=extractCS(spec,"h",angle,pset[0],0,"pass325");
  auto g2=extractCS(spec,"h",angle,pset[1],0,"pass325");
  auto g3=extractCS(spec,"h",angle,pset[2],0,"pass325");
  auto g4=extractCS(spec,"h",angle,pset[3],0,"pass325");
  auto g5=extractCS(spec,"d",angle,pset[0],0,"pass325");
  auto g6=extractCS(spec,"d",angle,pset[1],0,"pass325");
  auto g7=extractCS(spec,"d",angle,pset[2],0,"pass325");
  auto g8=extractCS(spec,"d",angle,pset[3],0,"pass325");
  auto g9=extractCS(spec,"r",angle,pset[0],0,"pass325");
  auto g10=extractCS(spec,"r",angle,pset[1],0,"pass325");
  auto g11=extractCS(spec,"r",angle,pset[2],0,"pass325");
  auto g12=extractCS(spec,"r",angle,pset[3],0,"pass325");
  if(spec=="hms"){
  g13=extractCS(spec,"h",angle,pset[4],0,"pass325");
  g14=extractCS(spec,"d",angle,pset[4],0,"pass325");
  g15=extractCS(spec,"r",angle,pset[4],0,"pass325");
  }
  auto g20=extractCS(spec,"h",angle,pset[0],5,"pass324");
  auto g21=extractCS(spec,"h",angle,pset[1],5,"pass324");
  auto g22=extractCS(spec,"h",angle,pset[2],5,"pass324");
  auto g23=extractCS(spec,"h",angle,pset[3],5,"pass324");
  auto g24=extractCS(spec,"d",angle,pset[0],5,"pass324");
  auto g25=extractCS(spec,"d",angle,pset[1],5,"pass324");
  auto g26=extractCS(spec,"d",angle,pset[2],5,"pass324");
  auto g27=extractCS(spec,"d",angle,pset[3],5,"pass324");
  auto g28=extractCS(spec,"r",angle,pset[0],5,"pass324");
  auto g29=extractCS(spec,"r",angle,pset[1],5,"pass324");
  auto g30=extractCS(spec,"r",angle,pset[2],5,"pass324");
  auto g31=extractCS(spec,"r",angle,pset[3],5,"pass324");

  if(spec=="hms"){
  g32=extractCS(spec,"h",angle,pset[4],5,"pass324");
  g33=extractCS(spec,"d",angle,pset[4],5,"pass324");
  g34=extractCS(spec,"r",angle,pset[4],5,"pass324");
  }
